...
export class NimiqAssetAdapter implements AssetAdapter<SwapAsset.NIM> {
    ...
    private async findTransaction(
        ...
        return new Promise(async (resolve, reject) => {
            ...
            // Also re-check transaction history every few seconds to catch cases where subscription fails
            // or a short connection outage happened that didn't register as a consensus event.
            const historyCheckInterval = window.setInterval(checkHistory, 5e3); // Every 5 seconds
